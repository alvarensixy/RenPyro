...
from rens import CMD_HELP, StartTime


modules = CMD_HELP
alive_logo = (
    gvarstatus("ALIVE_LOGO") or "https://telegra.ph/file/bfeaee5bd137534dedc7e.jpg"
)
emoji = gvarstatus("ALIVE_EMOJI") or "🥷"
alive_text = gvarstatus("ALIVE_TEKS_CUSTOM") or "Hey bro, I am rens."
...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**«[RenPyro-Bot](https://github.com/alvarensixy/RenPyro)»**\n\n"
        f"━───────╯•╰───────━\n"
        ...
        f"    **[Support](https://t.me/{GROUP})** | **[Channel](https://t.me/{CHANNEL})** | **[Owner](t.me/senaex)**"
    )
    try:
...
async def setalivelogo(client: Client, message: Message):
    try:
        import rens.helpers.SQL.globals as sql
