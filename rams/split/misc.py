...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("rens").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("rens").info(f"Invalid Git Command")
        ...
        LOGGER("rens").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("rens").info(f"Heroku App Configured")
...
async def create_botlog(client):
    ...
    desc = "Group Log untuk RenPyro-Bot.\n\nHARAP JANGAN KELUAR DARI GROUP INI.\n\n☀️ Powered By ~ @rensixy ✅"
    try:
